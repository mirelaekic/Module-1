...
const positiveNumbers = [3, 4, 5, 6, 7];
...
const drivinglicense = Boolean("driving license");
...
const info2 = {
    name: "Mirela",
    surname: "Ekic",
    emailAddress: "mirelaek@outlook.com",
}

console.log(info2);
console.log(info.emailAddress !== info2.emailAddress);
